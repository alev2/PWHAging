...
%   Detailed explanation goes here
    ...
    hold on
    semilogy(ageMesh(1:end-1),1-exp(-mortRates(1:end-1,6)),'--','Color',colorMat(2,:),'LineWidth',lw);
    semilogy(ageMesh(1:end-1),1-exp(-mortRates(1:end-1,11)),'--','Color',colorMat(3,:),'LineWidth',lw);
    semilogy(ageMesh(1:end-1),1-exp(-mortRates(1:end-1,15)),'--','Color',colorMat(4,:),'LineWidth',lw);
    legend({'2009','2013','2017','2021'},'FontSize',legendfs,'Interpreter','latex','location','northwest','NumColumns',2);
